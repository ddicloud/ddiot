 ...
 * @Last Modified time: 2021-04-12 22:23:17
 */
    ...
    public function init()
    {
        ...
        foreach ($this->titles as $key => $title) {
            ...
            if($this->options){
                ...
                $UrlOption = http_build_query($_GPC);

                $UrlS = explode('&',$UrlOption);

                $active = (Yii::$app->controller->action->id == $this->urls[$key] && in_array($option,$UrlS))?true:false;
