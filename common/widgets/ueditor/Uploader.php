 ...
 * @Last Modified time: 2022-01-08 14:53:03
 */

namespace common\widgets\ueditor;

use Alioss\Core\MimeTypes;
use common\components\FileUpload\OssUpload;
...
//        $this->stateMap['ERROR_TYPE_NOT_ALLOWED'] = iconv('unicode', 'utf-8', $this->stateMap['ERROR_TYPE_NOT_ALLOWED']);
    ...
    public function getFileInfo()
    {
        ...
        $fullName = $this->fullName;
        $fullName = str_replace('/admin/../attachment/', '', $fullName);
        $uploadSuccessPath = str_replace('../attachment/', '', $fullName);
        // oss处理
        ...
        $Mimetype = MimeTypes::getMimetype($uploadSuccessPath);
        ImageHelper::uploadDb($uploadSuccessPath,$this->fileSize,$Mimetype, $this->fileType,
        $uploadSuccessPath, 0, $storage);

        if ($storage != 'local') {
            $fullName = ImageHelper::tomedia($uploadSuccessPath);
        }
