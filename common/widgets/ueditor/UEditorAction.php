 ...
 * @Last Modified time: 2022-01-08 15:21:16
 */
...
class UEditorAction extends Action
{
    ...
    public function init()
    {
        ...
        //添加图片默认root路径；
        $_config['imageRoot'] = $upload_path;
        $_config['scrawlRoot'] = $upload_path;
        $_config['videoRoot'] = $upload_path;
        $_config['fileRoot'] = $upload_path;
        $_config['headers'] = [
            'bloc-id'=>$_GPC['bloc-id'],
            'store-id'=>$_GPC['store-id'],
