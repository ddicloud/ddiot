 ...
 * @Last Modified time: 2020-12-28 16:10:04
 */
 ...
 */
class HubOrderGoods extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['goods_id','bloc_id','store_id',  'deduct_stock_type', 'spec_type', 'goods_spec_id', 'total_num', 'order_id', 'user_id', 'wxapp_id', 'create_time','goods_type','is_rebate'], 'integer'],
            [['content', 'thumb'], 'required'],
            [['goods_no', 'content', 'thumb'], 'string'],
            [['goods_price', 'line_price', 'stock_up', 'goods_weight', 'total_price','performance','goods_costprice'], 'number'],
