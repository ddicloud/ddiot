 ...
 * @Last Modified time: 2022-03-01 18:55:37
 */
...
use common\plugins\diandi_hub\models\order\HubExpressCompany;
...
use common\plugins\diandi_hub\models\Searchs\order\HubOrderSearch;
...
{
    public $modelSearchName = 'HubOrderSearch';
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new HubOrderSearch();
    ...
    public function actionUpaddress()
    {
        ...
        if (Yii::$app->request->isPost) {
            ...
            $datas = [
                'name' => $data['HubOrderAddress']['name'],
                'phone' => $data['HubOrderAddress']['phone'],
                'province_id' => $data['HubOrderAddress']['province_id'],
                'city_id' => $data['HubOrderAddress']['city_id'],
                'region_id' => $data['HubOrderAddress']['region_id'],
                'detail' => $data['HubOrderAddress']['detail'],
            ];
            $order_id = $data['HubOrderAddress']['order_id'];
