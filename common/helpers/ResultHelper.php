...
class ResultHelper
{
     ...
     * @return array|null
     */
    public static function json(int $code = 404, string $message = '未知错误', array $data = []): array|null
    {
     ...
     * @param object|array $data    返回的数据结构
     */
    protected static function SocketBaseJson($type, int $code, string $message, object|array $data): bool|string
    {
        $result = [
            'type' => $type,
            'data' => [
