 ...
 * @Last Modified time: 2022-08-12 13:33:36
 */
...
class TcpServerController extends BaseController implements SwooleServer
{
    ...
    {
        parent::init();
        $confPath = Yii::getAlias('@dddons/'.$this->addons.'config/swoole/base.php');
        if(file_exists($confPath)){
            $config = require Yii::getAlias('@dddons/'.$this->addons.'config/swoole/base.php');
