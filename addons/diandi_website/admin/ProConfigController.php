...
use addons\diandi_website\models\searchs\WebsiteProConfig as WebsiteProConfigSearch;
...
class ProConfigController extends AController
{
    ...
    public function actionView($id)
    {
        ...
        $view = WebsiteProConfig::find()->where(['store_id' => $_GPC['store_id']])->asArray()->one();
        // if ($view) {
    ...
    public function actionCreate()
    {
        ...
        $where['store_id'] = $_GPC['store_id'];
        $is_add = $website_model->find()->where(['store_id' => $_GPC['store_id']])->asArray()->one();
