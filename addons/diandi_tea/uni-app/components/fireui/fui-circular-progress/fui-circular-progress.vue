<template>
	<view class="fui-circular-container" :style="{ width: diam + 'px', height: (height || diam) + 'px' }">
		<canvas class="fui-circular-default" :canvas-id="defaultCanvasId" :id="defaultCanvasId" :style="{ width: diam + 'px', height: (height || diam) + 'px' }"
		 v-if="defaultShow"></canvas>
		<canvas class="fui-circular-progress" :canvas-id="progressCanvasId" :id="progressCanvasId" :style="{ width: diam + 'px', height: (height || diam) + 'px' }"></canvas>
		<slot />
	</view>
</template>
