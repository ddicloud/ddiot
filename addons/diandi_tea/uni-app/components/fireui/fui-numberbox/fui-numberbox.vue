<template>
	<view class="fui-numberbox">
		...
		<input type="number" v-model="inputValue" :disabled="disabled" @blur="blur" class="fui-num-input" :style="{color:color,fontSize:size+'rpx',backgroundColor:backgroundColor,height:height+'rpx',minHeight:height+'rpx',width:width+'rpx'}" />
		<view class="fui-numbox-icon fui-icon-plus" :class="[disabled || value>=max?'fui-disabled':'']" @tap="plus" :style="{color:iconColor,fontSize:iconSize+'rpx'}"></view>
	</view>
</template>
