	...
	<view class="fui-container" @touchmove.stop.prevent="stop">
		<view class="fui-image-cropper" @touchend="cutTouchEnd" @touchstart="cutTouchStart" @touchmove="cutTouchMove">
			<view class="fui-content">
				<view class="fui-content-top fui-bg-transparent" :style="{ height: cutY + 'px', transitionProperty: cutAnimation ? '' : 'background' }"></view>
				<view class="fui-content-middle" :style="{ height: canvasHeight + 'px' }">
					<view class="fui-bg-transparent" :style="{ width: cutX + 'px', transitionProperty: cutAnimation ? '' : 'background' }"></view>
					<view
