 ...
 * @Date:   2022-02-27 10:37:00
 * @Last Modified by:   Wang chunsheng  email:2192138785@qq.com
 * @Last Modified time: 2022-02-28 09:34:51
 */
...
if ($action == 'db') {
    if ($ispost) {
        ...
        if (empty($error)) {
            ...
            $dbfile = IA_ROOT.'/data/db-1.x.php';
            if (file_exists(IA_ROOT.'/index.php') && is_dir(IA_ROOT.'/web') && file_exists($verfile) && file_exists($dbfile)) {
                ...
                die('<script type="text/javascript">alert("你正在使用本地安装, 但未下载完整安装包, 请从店滴云官网下载完整安装包后重试.");history.back();</script>');
            }
            $salt = local_salt(8);
...
<html lang="zh-cn">
	<head>
		...
		<title>安装系统 - 店滴云 - 免费的多商户业务引擎</title>
		<link rel="stylesheet" href="//cdn.tuhuokeji.com/public/css/bootstrap.css">
		<style>
	...
	<body style="background-color:#191b5ccc;">
		<div class="container" style="width:1200px;">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					<li role="presentation" class="active"><a href="javascript:;"  target="_block">安装店滴云系统</a></li>
					<li role="presentation"><a href="https://www.dandicloud.com/" target="_block">店滴云官网</a></li>
					<li role="presentation"><a href="https://www.hopesfire.com/"  target="_block">访问论坛</a></li>
				</ul>
				<img src="https://www.dandicloud.com/attachment/202201/09/40f6c1af-08a5-341a-8983-b25067e1ab88.png" width="120px" />
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="https://www.dandicloud.com/">关于店滴云</a> &nbsp; &nbsp; <a href="http://bbs.w7.cc">店滴云帮助</a> &nbsp; &nbsp; <a href="https://www.dandicloud.com/">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a href="https://www.dandicloud.com/"><b>店滴云</b></a> v2.0.0 &copy; 2014 <a href="https://www.dandicloud.com/">www.w7.cc</a>
				</div>
			</div>
		</div>
		<script src="//cdn.tuhuokeji.com/public/js/lib/jquery-1.11.1.min.js"></script>
		<script src="//cdn.tuhuokeji.com/public/js/lib/bootstrap.min.js"></script>
	</body>
</html>
EOF;
    echo trim($tpl);
    ...
    echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2014，店滴云团队保留所有权利。 </h3>
				<p>
					感谢您选择店滴云 - 微信公众平台自助开源引擎（以下简称WE7，WE7基于 PHP + MySQL的技术开发，全部源码开放。 <br />
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于店滴云系统(We7, MicroEngine. 以下简称店滴云)任何版本，店滴云官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
					<strong>二、协议许可的权利 </strong>
					<ol>
						<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
						<li>您可以在协议规定的约束和限制范围内修改店滴云源代码或界面风格以适应您的网站要求。</li>
				...
				<p>
					...
					<ol>
						...
						<li>未经官方许可，禁止在店滴云的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
...
function tpl_install_env($ret = [])
{
    ...
    echo <<<EOF
		...
		<div class="alert alert-info">系统要求店滴云整个安装目录必须可写, 才能使用店滴云所有功能。</div>
		<div class="panel panel-default">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<div class="help-block hidden">
							...
							在线安装能够直接安装最新版本店滴云系统, 如果在线安装困难, 请下载离线安装包后使用本地安装. <br/>
...
function tpl_install_finish()
{
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“店滴云 - 公众平台自助开源引擎”系统，您现在可以: <a target="_blank" class="btn btn-success" href="">访问网站首页</a>
	</div>
