 ...
 * @Last Modified time: 2021-12-12 23:36:53
 */
...
$WechatHeader = $settings->get('Wechat', 'headimg');
$WxapptHeader = $settings->get('Wxapp', 'headimg');
$statcode = $settings->get('Website', 'statcode');
...
<section id="content">
	...
	<div id="content-wrap">
		...
		<div id="newsletter-subscribe" class="section-parallax" data-scroll-index="5">
					...
					<div class="row mt-20">
						...
						<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
							...
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-center ">
								...
								<img src="<?= ImageHelper::tomedia($WechatHeader); ?>" alt="" width="120">
							</div>
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-center ">
								<p class="text-white">软硬件应用市场</p>	
								<img src="<?= ImageHelper::tomedia($WxapptHeader); ?>" alt="" width="120">
							</div>
