						...
						<div class="col-md-12">
							<div class="top-content">
								...
								<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
									<a class="text-white" target="_block" href="http://doc.hopesfire.com/">开发文档</a>
									<span>|</span>
									<a class="text-white" target="_block" href="/index.php?r=doc">接口文档</a>
									<span>|</span>
									<a class="text-white" target="_block" href="https://www.hopesfire.com/forum.php?mod=viewthread&tid=29">安装教程</a>
									<span>|</span>
									<a class="text-white" target="_block" href="http://www.hopesfire.com/">粉丝社区</a>
								</div>

								<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
									<a class="text-white" href="/backend">登录</a>
									<span>/</span>
									<a class="text-white" href="/backend/site/signup">注册</a>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="col-md-12">
									...
									<div class="hb-content">
										...
										<ul id="menu-main" class="menu-main">
											...
											<li><a href="#newsletter-subscribe" data-scroll-nav="5">关于店滴</a></li>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="fb-row">
										<div class="col-xs-6 col-xs-offset-1 text-white">
											<?= $settings->get('Website', 'footerleft'); ?><a href="https://beian.miit.gov.cn/"><?= $settings->get('Website', 'code'); ?></a>
										</div>
										<div class="col-xs-6 col-xs-offset-1 text-right text-white">
