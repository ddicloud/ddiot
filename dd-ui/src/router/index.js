 ...
 * @Last Modified time: 2023-03-11 10:48:53
 */
import Vue from 'vue'
...
import LoginMap from '@/components/login/login-router.js'
...
export const constantRoutes = [
  ...
  {
    path: '/qcord',
    component: LoginMap['login-qcord'],
    hidden: true
  },
  {
    path: '/register',
  ...
  {
    path: '/seting-index',
    component: diandiAdmin['setting-index'],
    hidden: true
  },
  {
    path: '/system-account-index',
    component: diandiAdmin['system-account-index'],
    hidden: true
  },
  {
    path: '/setting-administrator',
    component: diandiAdmin['setting-administrator'],
    hidden: true
  },
  {
    path: '/setting-attestation',
    component: diandiAdmin['setting-attestation'],
    hidden: true
  },
  {
    path: '/setting-storeattest',
    component: diandiAdmin['setting-storeattest'],
    hidden: true
  },
  {
    path: '/system-notification-index',
    component: diandiAdmin['system-notification-index'],
    hidden: true
  },
  {
    path: '/diandi',
...
const constantRoutesList = constantRoutes.concat(service)
...
const createRouter = () =>
  new Router({
    ...
    base: '/system-store-index',
    scrollBehavior: () => ({
      y: 0
    }),
    routes: asyncRoutes.concat(constantRoutesList)
