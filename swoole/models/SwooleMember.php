 ...
 * @Last Modified time: 2022-08-19 17:42:12
 */
...
class SwooleMember extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['member_id','id','bloc_id', 'group_id', 'level', 'store_id', 'gender', 'status', 'address_id', 'create_time', 'update_time', 'organization_id'], 'integer'],
