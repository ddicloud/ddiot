 ...
 * @Last Modified time: 2022-11-30 10:22:23
 */
 ...
 *
 * @since
 * php ./yii diandi_watches/pool/run --bloc_id=1 --store_id=1  建议使用
 ...
 */
class PoolController extends BaseController implements SwooleInterfaceController
{
    public $server;
