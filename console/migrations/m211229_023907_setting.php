...
class m211229_023907_setting extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%setting}}',['id'=>'16','cate_name'=>NULL,'type'=>'string','section'=>'Website','key'=>'flogo','store_id'=>NULL,'bloc_id'=>NULL,'value'=>'202109/12/94cd0bae-0343-3bdc-b15f-17f4b2d85cff.png','status'=>'1','description'=>NULL,'created_at'=>'1614358572','updated_at'=>'1631462347']);
        $this->insert('{{%setting}}',['id'=>'17','cate_name'=>NULL,'type'=>'string','section'=>'Website','key'=>'blogo','store_id'=>NULL,'bloc_id'=>NULL,'value'=>'202109/12/d9050275-3a00-3892-865e-019074369d0f.png','status'=>'1','description'=>NULL,'created_at'=>'1614358572','updated_at'=>'1631462379']);
        $this->insert('{{%setting}}',['id'=>'18','cate_name'=>NULL,'type'=>'string','section'=>'Website','key'=>'name','store_id'=>NULL,'bloc_id'=>NULL,'value'=>'开发测试系统','status'=>'1','description'=>NULL,'created_at'=>'1614358572','updated_at'=>'1637550542']);
