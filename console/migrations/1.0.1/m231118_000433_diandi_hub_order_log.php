...
class m231118_000433_diandi_hub_order_log extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%diandi_hub_order_log}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='价格字段说明'");
        
        /* 索引设置 */
        $this->createIndex('member_id','{{%diandi_hub_order_log}}','goods_spec_id',0);
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%diandi_hub_order_log}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}
