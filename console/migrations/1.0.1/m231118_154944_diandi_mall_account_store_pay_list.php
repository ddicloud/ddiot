...
class m231118_154944_diandi_mall_account_store_pay_list extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%diandi_mall_account_store_pay_list}}', [
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%diandi_mall_account_store_pay_list}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}
