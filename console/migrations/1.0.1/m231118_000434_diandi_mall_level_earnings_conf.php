...
class m231118_000434_diandi_mall_level_earnings_conf extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%diandi_mall_level_earnings_conf}}', [
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%diandi_mall_level_earnings_conf}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}
