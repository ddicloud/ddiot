...
class m231118_000438_swoole_member_copy1 extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%swoole_member_copy1}}', [
        ...
        /* 表数据 */
        $this->insert('{{%swoole_member_copy1}}',['id'=>'1','member_id'=>'1','group_id'=>'0','level'=>NULL,'store_id'=>NULL,'bloc_id'=>'0','username'=>NULL,'mobile'=>NULL,'address'=>NULL,'nickName'=>'','avatarUrl'=>'','gender'=>'0','country'=>'','province'=>'','status'=>'0','city'=>'','address_id'=>'0','invitation_code'=>'0','verification_token'=>NULL,'create_time'=>'0','update_time'=>'0','auth_key'=>'','password_hash'=>'','password_reset_token'=>NULL,'realname'=>NULL,'avatar'=>NULL,'qq'=>NULL,'vip'=>NULL,'birthyear'=>NULL,'constellation'=>NULL,'zodiac'=>NULL,'telephone'=>NULL,'idcard'=>NULL,'studentid'=>NULL,'grade'=>NULL,'zipcode'=>NULL,'nationality'=>NULL,'resideprovince'=>NULL,'graduateschool'=>NULL,'company'=>NULL,'education'=>NULL,'occupation'=>NULL,'position'=>NULL,'revenue'=>NULL,'affectivestatus'=>NULL,'lookingfor'=>NULL,'bloodtype'=>NULL,'height'=>NULL,'weight'=>NULL,'alipay'=>NULL,'msn'=>NULL,'email'=>NULL,'taobao'=>NULL,'site'=>NULL,'bio'=>NULL,'interest'=>NULL,'organization_id'=>NULL]);
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%swoole_member_copy1}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}
