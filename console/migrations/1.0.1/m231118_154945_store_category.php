...
class m231118_154945_store_category extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='分类管理'");
        ...
        $this->insert('{{%store_category}}',['category_id'=>'57','bloc_id'=>'51','name'=>'分类名称测试授权','parent_id'=>'0','thumb'=>'202303/14/e98ade47-c755-3dc0-9e69-b68e5d00784e.png','sort'=>'0','create_time'=>'1678786047','update_time'=>'1678786047']);
