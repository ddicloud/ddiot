...
class m231118_000433_diandi_hub_messages_read extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%diandi_hub_messages_read}}',['id'=>'2','admin_id'=>'11','message_id'=>'4','created_at'=>'2022-11-07 15:25:02']);
