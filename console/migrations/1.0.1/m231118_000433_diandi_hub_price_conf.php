...
class m231118_000433_diandi_hub_price_conf extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%diandi_hub_price_conf}}', [
        ...
        /* 索引设置 */
        $this->createIndex('member_id','{{%diandi_hub_price_conf}}','level_id',0);
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%diandi_hub_price_conf}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}
