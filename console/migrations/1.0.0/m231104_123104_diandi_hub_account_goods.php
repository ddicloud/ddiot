...
class m231104_123104_diandi_hub_account_goods extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%diandi_hub_account_goods}}', [
        ...
        /* 索引设置 */
        $this->createIndex('row_col_levelnum','{{%diandi_hub_account_goods}}','row_col_levelnum, goods_id',1);
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%diandi_hub_account_goods}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}
