...
class m231104_123106_user_bloc extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%user_bloc}}',['id'=>'226','user_id'=>'84','bloc_id'=>'91','status'=>'0','is_default'=>'1','create_time'=>'1698590812','update_time'=>'1698590812']);
