...
class m231104_123105_diandi_mall_basegoods_param extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%diandi_mall_basegoods_param}}', [
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%diandi_mall_basegoods_param}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}
