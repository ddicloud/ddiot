...
class m231104_123105_diandi_mall_basegoods_order_log extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 创建表 */
        $this->createTable('{{%diandi_mall_basegoods_order_log}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=FIXED COMMENT='商品多规格分销价格'");
        
        /* 索引设置 */
        $this->createIndex('member_id','{{%diandi_mall_basegoods_order_log}}','goods_id',0);
    ...
    public function down()
    {
        $this->execute('SET foreign_key_checks = 0');
        /* 删除表 */
        $this->dropTable('{{%diandi_mall_basegoods_order_log}}');
        $this->execute('SET foreign_key_checks = 1;');
    }
}
