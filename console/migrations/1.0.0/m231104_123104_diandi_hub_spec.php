...
class m231104_123104_diandi_hub_spec extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%diandi_hub_spec}}',['spec_id'=>'17','bloc_id'=>'0','store_id'=>'0','spec_name'=>'一年','category_id'=>NULL,'wxapp_id'=>'0','create_time'=>'1666951762']);
        $this->insert('{{%diandi_hub_spec}}',['spec_id'=>'18','bloc_id'=>'0','store_id'=>'0','spec_name'=>'两年','category_id'=>'19','wxapp_id'=>'0','create_time'=>'1666953952']);
        $this->insert('{{%diandi_hub_spec}}',['spec_id'=>'19','bloc_id'=>'35','store_id'=>'86','spec_name'=>'一年','category_id'=>'21','wxapp_id'=>'0','create_time'=>'1667642054']);
