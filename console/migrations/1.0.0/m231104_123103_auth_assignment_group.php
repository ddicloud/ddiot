...
class m231104_123103_auth_assignment_group extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%auth_assignment_group}}',['id'=>'66','group_id'=>'59','item_id'=>'59','item_name'=>'基础权限组','user_id'=>'84','created_at'=>'1674831154']);
