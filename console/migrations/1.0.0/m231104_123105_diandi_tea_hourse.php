...
class m231104_123105_diandi_tea_hourse extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%diandi_tea_hourse}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='包间表'");
        
        /* 索引设置 */
        
        
        /* 表数据 */
        $this->insert('{{%diandi_tea_hourse}}',['id'=>'5','bloc_id'=>'91','store_id'=>'153','create_time'=>'2023-11-04 19:36:59','update_time'=>'2023-10-31 16:32:01','name'=>'鸿儒堂','picture'=>'202310/31/af5f08af-ce50-3a06-b125-dd5e574de5b9.jpg','introduce'=>'1.WiFi账号:点到为止茶室,密码:diandaoweizhi888;
2.本茶室禁止从事黄赌毒行为;
