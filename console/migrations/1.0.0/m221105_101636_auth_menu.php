...
class m221105_101636_auth_menu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%auth_menu}}',['id'=>'1','name'=>'权限','parent'=>'75','route_id'=>'3453','route'=>'/main/index.vue','order'=>'1','data'=>NULL,'type'=>'auth','level_type'=>'3','icon'=>'el-dd-deleteteam','is_sys'=>'system','module_name'=>'sys','is_show'=>'0']);
        ...
        $this->insert('{{%auth_menu}}',['id'=>'197','name'=>'站点信息','parent'=>'75','route_id'=>'430','route'=>'/website/setting/website','order'=>'0','data'=>NULL,'type'=>'sysai','level_type'=>'5','icon'=>'el-dd-laptop','is_sys'=>'system','module_name'=>'sys','is_show'=>'0']);
        ...
        $this->insert('{{%auth_menu}}',['id'=>'1396','name'=>'关闭业务','parent'=>'254','route_id'=>'4171','route'=>'/addons/addons/uninstall.vue','order'=>'0','data'=>NULL,'type'=>'','level_type'=>'4','icon'=>'el-dd-issuesclose','is_sys'=>'system','module_name'=>'sys','is_show'=>'0']);
        $this->insert('{{%auth_menu}}',['id'=>'1575','name'=>' 服务','parent'=>'0','route_id'=>'4318','route'=>'/service/subscription.vue','order'=>'6','data'=>NULL,'type'=>NULL,'level_type'=>'1','icon'=>NULL,'is_sys'=>'system','module_name'=>'sys','is_show'=>'0']);
        $this->insert('{{%auth_menu}}',['id'=>'1576','name'=>'服务订购','parent'=>'1575','route_id'=>'4318','route'=>'/service/subscription.vue','order'=>'0','data'=>NULL,'type'=>NULL,'level_type'=>'4','icon'=>'','is_sys'=>'system','module_name'=>'sys','is_show'=>'0']);
        $this->insert('{{%auth_menu}}',['id'=>'1577','name'=>'购买应用','parent'=>'1576','route_id'=>'4319','route'=>'/service/buy.vue','order'=>'0','data'=>NULL,'type'=>NULL,'level_type'=>'6','icon'=>'','is_sys'=>'system','module_name'=>'sys','is_show'=>'1']);
        $this->insert('{{%auth_menu}}',['id'=>'1578','name'=>'购买成功','parent'=>'1576','route_id'=>'4325','route'=>'/service/success.vue','order'=>'0','data'=>NULL,'type'=>NULL,'level_type'=>'6','icon'=>'','is_sys'=>'system','module_name'=>'sys','is_show'=>'1']);
        $this->insert('{{%auth_menu}}',['id'=>'1579','name'=>'订购记录','parent'=>'1576','route_id'=>'4326','route'=>'/service/register.vue','order'=>'0','data'=>NULL,'type'=>NULL,'level_type'=>'6','icon'=>'','is_sys'=>'system','module_name'=>'sys','is_show'=>'1']);
        $this->insert('{{%auth_menu}}',['id'=>'1580','name'=>'订购详情','parent'=>'1576','route_id'=>'4327','route'=>'/service/details.vue','order'=>'0','data'=>NULL,'type'=>NULL,'level_type'=>'6','icon'=>'','is_sys'=>'system','module_name'=>'sys','is_show'=>'1']);
        $this->insert('{{%auth_menu}}',['id'=>'1581','name'=>'消息中心','parent'=>'1576','route_id'=>'4329','route'=>'/system/notification/index.vue','order'=>'0','data'=>NULL,'type'=>NULL,'level_type'=>'6','icon'=>'','is_sys'=>'system','module_name'=>'sys','is_show'=>'1']);
        $this->insert('{{%auth_menu}}',['id'=>'1582','name'=>'发票管理','parent'=>'1575','route_id'=>'4320','route'=>'/invoice/index.vue','order'=>'0','data'=>NULL,'type'=>NULL,'level_type'=>'4','icon'=>'','is_sys'=>'system','module_name'=>'sys','is_show'=>'0']);
        $this->insert('{{%auth_menu}}',['id'=>'1583','name'=>'设置','parent'=>'0','route_id'=>'4321','route'=>'/setting/index.vue','order'=>'7','data'=>NULL,'type'=>NULL,'level_type'=>'1','icon'=>'','is_sys'=>'system','module_name'=>'sys','is_show'=>'0']);
        $this->insert('{{%auth_menu}}',['id'=>'1584','name'=>'设置','parent'=>'1583','route_id'=>'4321','route'=>'/setting/index.vue','order'=>'0','data'=>NULL,'type'=>NULL,'level_type'=>'4','icon'=>'','is_sys'=>'system','module_name'=>'sys','is_show'=>'0']);
        ...
        $this->insert('{{%auth_menu}}',['id'=>'1611','name'=>'消息','parent'=>'75','route_id'=>'3453','route'=>'/main/index.vue','order'=>'4','data'=>NULL,'type'=>NULL,'level_type'=>'3','icon'=>NULL,'is_sys'=>'system','module_name'=>'sys','is_show'=>'0']);
