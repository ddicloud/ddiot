...
class m221105_114956_setting extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%setting}}',['id'=>'17','cate_name'=>NULL,'type'=>'string','section'=>'Website','key'=>'blogo','store_id'=>NULL,'bloc_id'=>NULL,'value'=>'202210/24/794bdeb4-853e-3300-828f-704ef1a9a3b4.png','status'=>'1','description'=>NULL,'created_at'=>'1614358572','updated_at'=>'1666595468']);
        ...
        $this->insert('{{%setting}}',['id'=>'31','cate_name'=>NULL,'type'=>'string','section'=>'Website','key'=>'is_send_code','store_id'=>NULL,'bloc_id'=>NULL,'value'=>'1','status'=>'1','description'=>NULL,'created_at'=>'1653963031','updated_at'=>'1657592267']);
