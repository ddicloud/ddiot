...
class m220228_021726_addons extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%addons}}',['mid'=>'163','is_nav'=>NULL,'identifie'=>'diandi_party','type'=>'base','title'=>'企业党建','version'=>'1.0.0','ability'=>'企业内部党建','description'=>'企业内部党建','author'=>'chunchun','url'=>'','settings'=>'0','logo'=>'','versions'=>NULL,'is_install'=>NULL]);
