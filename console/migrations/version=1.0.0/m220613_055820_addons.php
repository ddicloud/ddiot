...
class m220613_055820_addons extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%addons}}',['mid'=>'140','is_nav'=>NULL,'identifie'=>'diandi_distribution','type'=>'base','title'=>'店滴分销','version'=>'1.0.0','ability'=>'1','description'=>'分销','author'=>'wanchunsheng','url'=>'www.baidu.com','settings'=>'0','logo'=>'/backend/addons/addons/logo?addon=diandi_distribution','versions'=>NULL,'is_install'=>NULL,'parent_mids'=>'0']);
        ...
        $this->insert('{{%addons}}',['mid'=>'160','is_nav'=>NULL,'identifie'=>'weihai_bigscreen','type'=>'base','title'=>'疫情城市防控','version'=>'1.0.0','ability'=>'微嗨数据大屏','description'=>'微嗨数据大屏','author'=>'chunchun','url'=>'','settings'=>'0','logo'=>'','versions'=>NULL,'is_install'=>NULL,'parent_mids'=>'0']);
        ...
        $this->insert('{{%addons}}',['mid'=>'184','is_nav'=>NULL,'identifie'=>'diandi_switch','type'=>'base','title'=>'智能开关','version'=>'1.0.0','ability'=>'智能开关','description'=>'智能开关','author'=>'王春生','url'=>'','settings'=>'0','logo'=>'','versions'=>NULL,'is_install'=>NULL,'parent_mids'=>'0']);
