...
class m211229_023907_auth_backend_menu extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%auth_backend_menu}}',['id'=>'222','name'=>'公司管理','parent'=>'0','route_id'=>'1518','route'=>'/addons/bloc/index','order'=>'0','data'=>NULL,'type'=>'','level_type'=>'3','icon'=>'fa fa-fw fa-cogs','is_sys'=>'system','module_name'=>'','is_show'=>'0']);
        ...
        $this->insert('{{%auth_backend_menu}}',['id'=>'997','name'=>'商户','parent'=>'0','route_id'=>'1549','route'=>'/addons/store/index','order'=>'1','data'=>NULL,'type'=>'','level_type'=>'3','icon'=>'','is_sys'=>'system','module_name'=>'','is_show'=>'0']);
