...
class m230714_032924_addons extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 表数据 */
        $this->insert('{{%addons}}',['mid'=>'172','is_nav'=>NULL,'identifie'=>'diandi_cloud','type'=>'bus','title'=>'插件管理','version'=>'1.0.0','ability'=>'店滴独立模块授权管理系统','description'=>'店滴独立模块授权管理系统','author'=>'chunchun','url'=>'https://www.hopesfire.com/','settings'=>'0','logo'=>'','versions'=>NULL,'is_install'=>NULL,'parent_mids'=>'0']);
        ...
        $this->insert('{{%addons}}',['mid'=>'201','is_nav'=>NULL,'identifie'=>'diandi_hotel','type'=>'base','title'=>'酒店','version'=>'1.0.0','ability'=>'1','description'=>'美恋云','author'=>'wangchunsheng','url'=>'www.ddicms.cn','settings'=>'0','logo'=>'1','versions'=>NULL,'is_install'=>NULL,'parent_mids'=>'0']);
        $this->insert('{{%addons}}',['mid'=>'202','is_nav'=>NULL,'identifie'=>'diandi_whsms','type'=>'base','title'=>'微嗨短信','version'=>'1.0.0','ability'=>'1','description'=>'美恋云','author'=>'wangchunsheng','url'=>'www.ddicms.cn','settings'=>'0','logo'=>'1','versions'=>NULL,'is_install'=>NULL,'parent_mids'=>'0']);
